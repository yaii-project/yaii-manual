...
\includesvg[width=0.6in]{media/Internet_Explorer_4_and_5_logo.svg}
\cite{IE}\footfullcite{IE}
...
您会在电脑桌面上看到它的主要原因是它随Windows一起捆绑售卖, 不过自Windows 10开始, 微软更换了新的Microsoft Edge, 它的图标是这样的: \includesvg[width=0.6in]{media/Edge_Logo_2019.svg}
\cite{MSEdge}\footfullcite{MSEdge}
...
您可以从 \url{https://www.mozilla.org/firefox/all/\#product-desktop-esr} 下载Firefox浏览器\footnote{又名火狐浏览器, 是一款开源软件. }, 打开网页后点击 \fakebutton[blue!80]{\color{white}立即下载}
\footnote{图中显示的选择是\fakebutton{Firefox延长支持版}, 这是考虑到仍然有Windows
7/8/8.1用户在阅读本手册, 如果您使用的是Windows
10/11等更新版本, 可以选择\fakebutton{Firefox}, 这样您就能保持更新到最新的功能. }
...
这两个界面都是为了保护您的电脑不受病毒侵扰, 特此向您确认是否要继续. 请按\fakebutton{运行}或\fakebutton{是}. 
